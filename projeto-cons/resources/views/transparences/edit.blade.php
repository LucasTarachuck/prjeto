...
@section('content')
    <form class="max-w-sm mx-auto" action="{{ url('transparence/'.$transparences>id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-5">
        ...
        <br>
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded" type="submit">Editar</button>
    </form>
@endsection